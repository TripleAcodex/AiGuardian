...
export default function HowItWorksV2() {
  ...
  useGSAP(
    () => {
      ...
      if (stepsEls.length > 0) {
        gsap.set(stepsEls, { opacity: 0, y: 50, scale: 0.97 });
  ...
  return (
    ...
    >
      {/* Top accent line */}
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-danger/20 to-transparent" />
      ...
      <div className="max-w-[1400px] mx-auto px-8">
        ...
        <div ref={headerRef} className="mb-28">
          ...
          >
            Camera to alert.
            <br />
            <span className="text-gradient-light">Under one second.</span>
          </h2>
        </div>
            ...
            return (
              <div key={step.num} className="relative flex flex-col">
                ...
                >
                  ...
                  <div
                    className="absolute top-0 left-4 md:left-6 text-[8rem] md:text-[10rem] font-bold font-[var(--font-heading)] text-white/[0.02] leading-none select-none pointer-events-none group-hover:text-danger/[0.06] transition-colors duration-700"
                    aria-hidden="true"
                  >
                    {step.num}
                  </div>
                  ...
                  <div className="relative z-10 pt-16 md:pt-24">
                    ...
                    <h3 className="inky text-2xl md:text-3xl font-bold text-primary font-[var(--font-heading)] tracking-[-0.02em] mb-4 group-hover:text-white transition-colors duration-300">
                      {step.title}
                    </h3>

                    <p className="text-base text-dim leading-relaxed max-w-xs">
                      {step.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-24 flex items-center gap-6">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-danger/20 to-transparent" />
          <span className="text-xs font-mono text-muted uppercase tracking-[0.2em] whitespace-nowrap">
            Total Latency: &lt; 300ms
          </span>
          <div className="h-px flex-1 bg-gradient-to-l from-transparent via-danger/20 to-transparent" />
        </div>
      </div>
    </section>
  );
